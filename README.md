...
Conclusions that can be drawn about outcomes based on goals are that it would be advisalble to have a goal that is between $1,000 and $4,999. However, additional analysis of measures of central tendency and spread are recommended to get more specific information before committing to an amount. The rationale for these conclusions are as follows:
